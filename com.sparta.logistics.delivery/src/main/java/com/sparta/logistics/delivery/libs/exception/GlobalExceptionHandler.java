...
import static com.sparta.logistics.delivery.libs.exception.ErrorCode.BAD_REQUEST;
import static com.sparta.logistics.delivery.libs.exception.ErrorCode.INTERNAL_SERVER_ERROR;

import com.sparta.logistics.delivery.libs.model.ErrorResponse;
import com.sparta.logistics.delivery.libs.model.ErrorResponse.ValidationError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleFeignException(FeignException e) {
        log.error("FeignException occurred : status = {} message = {}",
            e.status(), e.getMessage());

        return handleExceptionInternal(ErrorCode.SERVICE_UNAVAILABLE);
    }
}